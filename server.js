    ...
    async run() {
        ...
        while (true) {
            ...
            if (!data || data.length === 0) {
                process.stdout.write("Data fetching error... retrying\r".yellow);
            ...
            // Make new prediction for next issue
            ...
            if (this.targetIssue !== nextIssue) {
                ...
                process.stdout.write(
                    `[${t}] NEXT: ${nextIssue} | AI: ${cat} | PICK: ${nums}     \r`.cyan
                );
            }

            await setTimeout(800); // Faster polling for 30S game
        }
    }
}
