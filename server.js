...
class QuantumDeepAI {
    ...
    deepQuantumPredict(data) {
        ...
        const confidence = Math.abs(probability - 0.5) * 2 * 100; // Convert to 0-100%
    ...
    tracker(actualNum, issue) {
        ...
        // Store result for last 10 history
        ...
        console.log(`RESULT    : ${status === "WIN" ? "✅ WIN" : "❌ LOSS"}`);
...
// Trade endpoint - exactly like Harsh-AI
